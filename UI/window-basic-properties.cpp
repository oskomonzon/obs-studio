	  ...
	  buttonBox              (new QDialogButtonBox(this))
{
	...
	if (type == PropertiesType::Source) {
		...
		itemAdvanced = AdvancedTab(this, false);
		globalAdvanced = AdvancedTab(this, true);
...
QWidget *OBSBasicProperties::AdvancedTab(QWidget *parent, bool global)
{
